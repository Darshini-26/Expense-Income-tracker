...
@router.get("/", response_model=List[Expense],dependencies= [Depends(JWTBearer())])
...
# Fetch Expense by ID
@router.get("/{id}", response_model=Expense,dependencies= [Depends(JWTBearer())])
...
@router.post("/", response_model=Expense,dependencies= [Depends(JWTBearer())])
...
@router.put("/{id}", response_model=Expense,dependencies= [Depends(JWTBearer())])
